---
title: "Differential Expression Analysis via Command Line Interface"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Differential Expression Analysis via Command Line Interface}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

### Designed for RNA-seq workflows, **JW26ADS8192** provides a streamlined pipeline to differential expression results. Use supply raw count matrices and sample metadata (TSV/CSV) directly via the command-line interface.

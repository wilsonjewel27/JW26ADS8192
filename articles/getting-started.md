...
#> /tmp/RtmplgIrtp/de_output/de_results.tsv
#> /tmp/RtmplgIrtp/de_output/de_summary.tsv
#> /tmp/RtmplgIrtp/de_output/filtering_diagnostics.tsv
#> /tmp/RtmplgIrtp/de_output/volcano_plot.pdf
#> /tmp/RtmplgIrtp/de_output/volcano_plot.png
```

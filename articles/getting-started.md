...
#> /tmp/RtmpJCwXnf/de_output/de_results.tsv
#> /tmp/RtmpJCwXnf/de_output/de_summary.tsv
#> /tmp/RtmpJCwXnf/de_output/filtering_diagnostics.tsv
#> /tmp/RtmpJCwXnf/de_output/volcano_plot.pdf
#> /tmp/RtmpJCwXnf/de_output/volcano_plot.png
```

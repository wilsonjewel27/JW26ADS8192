...
#> /tmp/RtmpucGDpF/de_output/de_results.tsv
#> /tmp/RtmpucGDpF/de_output/de_summary.tsv
#> /tmp/RtmpucGDpF/de_output/filtering_diagnostics.tsv
#> /tmp/RtmpucGDpF/de_output/volcano_plot.pdf
#> /tmp/RtmpucGDpF/de_output/volcano_plot.png
```
